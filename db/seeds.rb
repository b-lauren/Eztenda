...
flintlock = Product.create!(name: "", description: "Flintlock is JJ Corry's 16 year old single malt aged in 3 ex-bourbon casks. Only made in limited quantities. On the nose sweet vanilla, pear and white peach with hints of yellow flowers. The palate is soft and gentle with ripe pear and stone fruits, a lick of sweet spice and vanilla essence. The whiskey is named after a pistol found in the rafters of its 17th century tasting barn.", drink_id: whiskey.id)
